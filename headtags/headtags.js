...
function clearAll() {    
    siteName.value === "";
    document.getElementById("siteName").style.borderColor="orange";
    resultName.innerText = "Website Page Title";

    siteURL.value === "";
    document.getElementById("siteURL").style.borderColor="orange";
    resultURL.innerText = "www.yourURLhere.com";

    siteDescription.value === "";
    document.getElementById("siteDescription").style.borderColor="orange";
    resultDescription.innerText = "Website Page Description goes here. Recommended between 50 - 150 characters long";
    meta.textContent = "";
}
// })
